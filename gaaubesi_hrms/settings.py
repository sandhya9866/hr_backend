"""
Django settings for gaaubesi_hrms project.
...
SECRET_KEY = 'django-insecure-1r^l2f+*x06z57^eg#&ee5t2@tu(vxndxzr+)*w(2&05mpbv=='
...
WSGI_APPLICATION = 'gaaubesi_hrms.wsgi.application'

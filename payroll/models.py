...
class SalaryRelease(models.Model):
    ...
    month = models.IntegerField(choices=NepaliMonthList, null=True, blank=True)
    ...
    net_amount = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, default=0, verbose_name='Net Amount')
